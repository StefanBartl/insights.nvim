---@module 'project_insight.conflicts'
...
local notify = require("project_insight.util.notify").create("[project_insight.conflicts]")
...
function M.run(opts)
  opts = opts or {}
  local cfg = require("project_insight.config").get().conflicts or {}
  ...
  fn.setqflist(qf, "r")
  fn.setqflist({}, "a", { title = "Project-Insight: git conflicts" })
