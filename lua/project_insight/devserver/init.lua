---@module 'project_insight.devserver'
...
local notify = require("project_insight.util.notify").create("[project_insight.devserver]")
...
local function ask(chan, cmd)
  local cfg = require("project_insight.config").get().devserver or {}
